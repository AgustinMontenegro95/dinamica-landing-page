...
import 'package:dinamica_landing_page/ui/terms_policies/terms_and_conditions_funds_advances/widgets/body_terms_and_conditions_funds_advances.dart';
import 'package:dinamica_landing_page/ui/widgets/my_drawer.dart';
import 'package:flutter/material.dart';
import 'package:responsive_framework/responsive_framework.dart';

class TermsAndConditionsFundsAdvancesPage extends StatelessWidget {
  const TermsAndConditionsFundsAdvancesPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const BodyTermsAndConditionsFundsAdvances(),
    );
  }
}
